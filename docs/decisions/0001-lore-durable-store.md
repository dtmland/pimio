...
`docs/plan/pimio-v1-implementation.md`). The durable-store choice stands; its
whole-store recovery strategy is superseded by decision 0006. Two original
findings still carry more weight:
